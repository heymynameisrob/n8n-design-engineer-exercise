  ...
  return (
    <div className="group/native-select relative w-fit has-[select:disabled]:opacity-50">
      <select
        ...
        className={cn(
          "border placeholder:text-gray-10 selection:bg-gray-3 selection:text-gray-12 h-9 w-full min-w-0 appearance-none rounded-md bg-gray-1 px-3 py-2 pr-9 text-sm transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed",
